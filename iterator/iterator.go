...
迭代器模式（Iterator Pattern）是 Java 和 .Net 编程环境中非常常用的设计模式。这种模式用于顺序访问集合对象的元素，不需要知道集合对象的底层表示。迭代器模式属于行为型模式。
	...
	source: https://www.runoob.com/design-pattern/iterator-pattern.html
*/
...
// Append ...
func (a *Array) Append(value interface{}, values ...interface{}) {
...
func (a *Array) Value() interface{} {
	return a.list[a.next-1]
}

// Next ...
func (a *Array) Next() bool {
	if a.next+1 > len(a.list) {
		return false
	}
	a.next++
	return true
